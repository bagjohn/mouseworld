# -*- coding: utf-8 -*-
"""
Modular Continuous Space Rendering
========================
Module for visualizing model objects in continuous space by providing the lists of agents.
"""
from collections import defaultdict
#from mesa.visualization.ModularVisualization import VisualizationElement
from mesa_mouseworld.visualization.ModularVisualization import VisualizationElement

class CanvasContinuousSpace(VisualizationElement):
    """ A CanvasContinuousSpace object uses a user-provided portrayal method to generate a
    portrayal for each object. A portrayal is a JSON-ready dictionary which
    tells the relevant JavaScript code (SpaceDraw.js) where to draw what shape.
    ...
    """
    #package_includes = ["CanvasModule.js"]
    local_includes = ["SpaceDraw.js","SpaceModule.js"]
    portrayal_method = None  # Portrayal function
    canvas_width = 500
    canvas_height = 500

    def __init__(self, portrayal_method, space_width, space_height,
                 canvas_width=500, canvas_height=500):
        """ Instantiate a new CanvasContinuousSpace.
...
#        return grid_state
    ...
    def render(self, model):
        ...
        for agent in (model.food_schedule.agents + model.schedule.agents + model.predator_schedule.agents) : 
